 ...
 * Date: 11/19/20
 * Assignment: Unit 11 Case Problems - Sammy RentalDemo
 */
...
public class RentalDemo {
    private static final int NUM_EVENTS = 8; // Number of Rental objects that will be stored in array
